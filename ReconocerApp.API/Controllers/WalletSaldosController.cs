...
public class WalletSaldosController : BaseCrudController<WalletSaldo, WalletSaldoResponse>
{
    ...
    {
        var baseQuery = _context.WalletSaldos
            .Include(ws => ws.Colaborador)
            .AsQueryable();
        ...
        if (!string.IsNullOrEmpty(filters))
        {
            ...
            // Apply filters specifically for Colaborador
            baseQuery = DynamicFilterService.ApplyFilters(baseQuery, parsedFilters.Where(f => f.Field == "Colaborador").ToList());
        }
